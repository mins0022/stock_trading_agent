...
class Agent:
    ...
    def __init__(
        self, environment, min_trading_unit=1, max_trading_unit=50, 
    ...
    def reset(self):
        ...
        self.num_stocks = self.initial_num_stocks
    ...
    def set_balance(self, balance, num_stocks):
        self.initial_balance = balance
        self.initial_num_stocks = num_stocks
        # print('set_balance', num_stocks)
    ...
    def decide_trading_unit(self, confidence):
        ...
        # print('confidence: ', confidence,'unit: ',int(self.min_trading_unit+added_traiding))#,'min: ',self.min_trading_unit)
        # print('-'*50)
    ...
    def act(self, action, confidence):
        ...
        if action == Agent.ACTION_BUY:
            ...
            if invest_amount > 0:
                ...
                self.num_buy += trading_unit   # 매수 횟수 증가
            print('action: ',action,', confidence: ',confidence,', buy/sell_trading_unit: ',trading_unit)
            print('-'*50)
        ...
        # 매도
            ...
            if invest_amount > 0:
                self.num_stocks -= trading_unit  # 보유 주식 수를 갱신
                self.balance += invest_amount  # 보유 현금을 갱신
                self.num_sell += trading_unit  # 매도 횟수 증가

        # 홀딩
        elif action == Agent.ACTION_HOLD:
            self.num_hold += 1  # 홀딩 횟수 증가
            print('action: ',action,', confidence: nan',', buy/sell_trading_unit: nan')
            print('-'*100)
